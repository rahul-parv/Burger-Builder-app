...
class ContactData extends Component {
    ...
    orderHandler = (event) => {
        ...
        this.props.onPurchaseOrderStart(orderDetails, this.props.token);
    }
...
const mapDispatchToProps = dispatch => {
    return {
        onPurchaseOrderStart: (orderDetails, token) => dispatch(actions.purchaseBurger(orderDetails, token))
    }
}
